...
class AddNewProductServiceScreen extends StatefulWidget {
  String? strType;
  AddNewProductServiceScreen({super.key, required this.strType});

  @override
  State<AddNewProductServiceScreen> createState() => _AddNewProductServiceScreenState();
}

class _AddNewProductServiceScreenState extends State<AddNewProductServiceScreen> {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            widget.strType == "Service" ? "Add New Service" : widget.strType == "Product" ? "Add New Product" : "Add New Requirement",
  ...
  _titleTextField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        labelText: widget.strType == "Service" ? "Service Name" : widget.strType == "Product" ? "Product Name" : "Name",
  ...
  _descTextField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        floatingLabelBehavior: FloatingLabelBehavior.always,
        labelText: widget.strType == "Service" ? "Service Description" : widget.strType == "Product" ? "Product Description" : "Description",
        labelStyle: CustomStyle.inputTextStyle.copyWith(fontSize: 16.0,fontWeight: FontWeight.w700,color: CustomColor.blackColor),
        border: UIUtils.textinputborder,
        contentPadding: UIUtils.textinputPadding,
        errorBorder: UIUtils.errorBorder,
  ...
  imageWidget(){
    return GestureDetector(
      ...
      child: Column(
        ...
        children: [
          Text(
            widget.strType == "Service" ? "Service Images" : widget.strType == "Product" ? "Product Images" : "Images",
  ...
  void addRequirements() {
    ConnectionUtils.checkConnection().then((internet) async {
      if (internet) {
        ...
        try {
          final ResultModel resultModel = await ApiManager.AddProductService(
              userId!,
